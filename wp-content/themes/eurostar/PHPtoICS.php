...
$summary = $_REQUEST['post_title'];
$datestart = $_REQUEST['post_date_start'];  
$dateend = $_REQUEST['post_date_ends'];    
$address = $_REQUEST['post_location'];   
$uri = $_REQUEST['post_link'];       
$description = $_REQUEST['post_desc'];
$filename = $_REQUEST['post_title'];
