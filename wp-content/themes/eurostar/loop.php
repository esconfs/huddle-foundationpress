...
<?php if ( ! have_posts() ) : ?>
	<article id="post-0" class="post error404 not-found">
		<h1 class="entry-title-search"><?php _e( 'Not Found', 'boilerplate' ); ?></h1>
...
<?php /* How to display posts in the asides category */ ?>
	...
	<?php elseif ( in_category( _x('asides', 'asides category slug', 'boilerplate') ) ) : ?>
		...
		<?php else : ?>
			<div class="entry-content">
				<?php the_content( __( '', 'boilerplate' ) ); ?>
			</div><!-- .entry-content -->
		<?php endif; ?>
...
<?php /* How to display all other posts. */ ?>
	...
	<?php else : ?>
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<h2 class="entry-title-search"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'boilerplate' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h2>
	...
	<?php if ( is_archive() || is_search() ) : // Only display excerpts for archives and search. ?>
			<div class="entry-summary">
				<?php the_excerpt(); ?>
				<?php if(get_post_type() == 'forum' OR get_post_type() == 'topic' OR get_post_type() == 'reply') { $post_type = 'forums'; } elseif (get_post_type() == 'post') { $post_type = 'blog'; } elseif (get_post_type() == 'resource') { $post_type = 'resource'; } else { $post_type =  get_post_type(); }?>
				<h5 class="entry-post-type"><?php echo $post_type; ?></h5>
			</div><!-- .entry-summary -->
	<?php else : ?>
			<div class="entry-content-search">
				<?php the_content( __( '', 'boilerplate' ) ); ?>
	...
	<?php endif; ?>
			...
			<div class="entry-utility">
				...
				<?php
					...
					if ( $tags_list ):
				?>
					<!-- <h5 class="entry-post-type"><?php printf( __( 'Resource: %2$s', 'boilerplate' ), 'entry-utility-prep entry-utility-prep-tag-links', $tags_list ); ?></h5> -->
				<?php endif; ?>
			</div><!-- .entry-utility -->
		</article><!-- #post-## -->
