...
<header role="banner" class="outer">
	...
	<!-- Header Top-->
	<div id="header_top" class="outer">
		<div id="header_top_inner" class="inner">
			<!-- Top Navigation -->
			<nav id="top_menu" role="navigation">
				<?php wp_nav_menu( array( 'container_class' => 'menu_header', 'menu' => 'Top Menu', ) ); ?>
			</nav>
			<ul id="top_buttons">
	...
	<!-- Header Bottom -->
	<div id="header_bottom" class="outer">
		<div id="header_bottom_inner" class="inner">
			<a id="logo" href="<?php echo home_url(); ?>" <?php if ( get_field('header_ad', 'option') ) { echo 'class="with_ad"'; } ?>>Huddle</a>
			<!-- Header Advertising -->
			<?php if ( get_field('header_ad', 'option') ) { ?>
				<a href="<?php the_field('header_ad_link', 'option'); ?>" title="" target="_blank" class="headertop_ad">
					<?php 
					$image = get_field('header_ad_image', 'option');
					$size = 'full';
					if( $image ) {
			...
			<?php if ( get_field('header_ad', 'option') ) { ?>
		</div><!-- header_bottom_inner ends -->
	</div><!-- header_bottom ends -->
	<div id="header_bottom_extra" class="outer">
		<div id="header_bottom_extra_inner" class="inner">
			<?php } ?>
			<!-- Mobile Only -->
			
			
			<nav id="main_menu" role="navigation" <?php if ( get_field('header_ad', 'option') ) { echo 'class="with_ad"'; } ?>>
				<?php
