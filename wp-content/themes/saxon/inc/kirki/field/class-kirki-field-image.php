...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_attr__( 'Select image', 'saxon' ),
				'change'       => esc_attr__( 'Change image', 'saxon' ),
				'default'      => esc_attr__( 'Default', 'saxon' ),
				'remove'       => esc_attr__( 'Remove', 'saxon' ),
				'placeholder'  => esc_attr__( 'No image selected', 'saxon' ),
				'frame_title'  => esc_attr__( 'Select image', 'saxon' ),
				'frame_button' => esc_attr__( 'Choose image', 'saxon' ),
			)
		);
	}
