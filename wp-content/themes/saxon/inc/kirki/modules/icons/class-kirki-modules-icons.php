...
class Kirki_Modules_Icons {
	...
	public function customize_controls_enqueue_scripts() {
		...
		wp_enqueue_script( 'kirki-panel-and-section-icons', trailingslashit( Kirki::$url ) . 'modules/icons/icons.js', array( 'jquery', 'customize-base', 'customize-controls' ), KIRKI_VERSION, true );
