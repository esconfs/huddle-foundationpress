...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'saxon' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'saxon' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'saxon' ),
			'200'       => esc_attr__( 'Light 200', 'saxon' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'saxon' ),
			'300'       => esc_attr__( 'Book 300', 'saxon' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'saxon' ),
			'400'       => esc_attr__( 'Normal 400', 'saxon' ),
			'regular'   => esc_attr__( 'Normal 400', 'saxon' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'saxon' ),
			'500'       => esc_attr__( 'Medium 500', 'saxon' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'saxon' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'saxon' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'saxon' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'saxon' ),
			'700'       => esc_attr__( 'Bold 700', 'saxon' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'saxon' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'saxon' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'saxon' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'saxon' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'saxon' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'saxon' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'saxon' ),
		);
	}
