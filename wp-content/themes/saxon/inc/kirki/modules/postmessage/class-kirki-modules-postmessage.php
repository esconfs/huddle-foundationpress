...
class Kirki_Modules_PostMessage {
	...
	public function postmessage() {
		...
		wp_enqueue_script( 'kirki-auto-postmessage', trailingslashit( Kirki::$url ) . 'modules/postmessage/postmessage.js', array( 'jquery', 'customize-preview' ), KIRKI_VERSION, true );
		$fields = Kirki::$fields;
		...
		wp_add_inline_script( 'kirki-auto-postmessage', $this->script, 'after' );
