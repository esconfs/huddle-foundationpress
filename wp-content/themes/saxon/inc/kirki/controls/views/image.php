...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_attr_e( 'Select image', 'saxon' ); ?>',
	change: '<?php esc_attr_e( 'Change image', 'saxon' ); ?>',
	'default': '<?php esc_attr_e( 'Default', 'saxon' ); ?>',
	remove: '<?php esc_attr_e( 'Remove', 'saxon' ); ?>',
	placeholder: '<?php esc_attr_e( 'No image selected', 'saxon' ); ?>',
	frame_title: '<?php esc_attr_e( 'Select image', 'saxon' ); ?>',
	frame_button: '<?php esc_attr_e( 'Choose image', 'saxon' ); ?>',
} );
#>
