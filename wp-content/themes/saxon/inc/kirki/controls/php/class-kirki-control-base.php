	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_attr__( 'No File Selected', 'saxon' ),
				'remove'               => esc_attr__( 'Remove', 'saxon' ),
				'default'              => esc_attr__( 'Default', 'saxon' ),
				'selectFile'           => esc_attr__( 'Select File', 'saxon' ),
				'standardFonts'        => esc_attr__( 'Standard Fonts', 'saxon' ),
				'googleFonts'          => esc_attr__( 'Google Fonts', 'saxon' ),
				'defaultCSSValues'     => esc_attr__( 'CSS Defaults', 'saxon' ),
				'defaultBrowserFamily' => esc_attr__( 'Default Browser Font-Family', 'saxon' ),
			)
		);
