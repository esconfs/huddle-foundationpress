...
// Load all fonts subsets for Google Fonts
if(get_theme_mod('webfonts_loadallsubsets', false)) {
...
// Google fonts method async/sync
// Include the alternative webfonts loading method.
include_once 'kirki/class-kirki-modules-webfonts-link.php';

if ( ! function_exists( 'saxon_change_fonts_load_method' ) ) {
    /**
     * Changes the font-loading method.
     *
     * @param string $method The font-loading method (async|link)
     */
    function saxon_change_fonts_load_method( $method ) {
        ...
        if ( 'link' === get_theme_mod( 'webfonts_load_method', 'link' ) ) {
            return 'link';
        }
        return $method;
    }
}
add_filter( 'kirki_googlefonts_load_method', 'saxon_change_fonts_load_method' );
...
Kirki::add_field( 'saxon_theme_options', array(
    ...
    'label'       => esc_attr__( 'Web Fonts loading method', 'saxon' ),
    'section'     => 'fonts',
    'default'     => 'link',
    'priority'    => 40,
    'choices'     => array(
        'js'   => esc_attr__( 'JS (Async)', 'saxon' ),
        'link' => esc_attr__( 'Link (Sync)', 'saxon' ),
    ),
    'description'  => esc_attr__( 'Async - faster,  Flash Of Unstyled Text (FOUT). Sync - slower, no FOUT.', 'saxon' ),
) );

Kirki::add_field( 'saxon_theme_options', array(
    'type'        => 'toggle',
    'settings'    => 'webfonts_loadallvariants',
    'label'       => esc_attr__( 'Load all Google Fonts variants', 'saxon' ),
    'description' => esc_attr__( 'Enable to load all available variants for fonts that you selected.', 'saxon' ),
    'section'     => 'fonts',
    'default'     => '0',
    'priority'    => 50,
) );
...
Kirki::add_field( 'saxon_theme_options', array(
    'type'        => 'toggle',
    'settings'    => 'webfonts_loadallsubsets',
    'label'       => esc_attr__( 'Load all Google Fonts subsets', 'saxon' ),
    'description' => esc_attr__( 'Enable to load all available subsets for fonts that you selected.', 'saxon' ),
    'section'     => 'fonts',
    'default'     => '0',
    'priority'    => 60,
) );
...
Kirki::add_field( 'saxon_theme_options', array(
    'type'        => 'select',
    'settings'    => 'color_skin',
    'label'       => esc_html__( 'Predefined color skin', 'saxon' ),
    'section'     => 'colors',
    'default'     => 'none',
    'priority'    => 10,
    'multiple'    => 0,
    'choices'     => array(
        'none'   => esc_attr__( 'Use colors specified below', 'saxon' ),
    ...
    'description' => esc_attr__( 'Select one of predefined skins or use your own colors. If you selected any predefined skins your colors below will NOT be applied.', 'saxon' ),
) );
...
Kirki::add_field( 'saxon_theme_options', array(
    ...
    'description' => esc_attr__( 'Used in alternative buttons, that does not use main theme color.', 'saxon' ),
    'section'     => 'colors',
    'default'     => '#000000',
    'priority'    => 25,
) );
