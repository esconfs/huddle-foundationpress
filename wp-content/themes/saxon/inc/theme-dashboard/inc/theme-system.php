		...
		public function dashboard_system(){
			...
			<div class="wrap about-wrap theme-dashboard-wrapper system-wrapper">
				...
				<h2 class="nav-tab-wrapper">
					...
					<a href="<?php echo admin_url( 'themes.php?page=saxon_activate_theme' ) ?>" class="nav-tab"><?php esc_html_e( 'Theme activation', 'saxon' ); ?></a>
					<?php endif; ?>
					<a href="<?php echo admin_url( 'themes.php?page=saxon_system_information' ) ?>" class="nav-tab nav-tab-active"><?php esc_html_e( 'System information', 'saxon' ); ?></a>
				...
				<a class="button-primary" href="<?php echo admin_url( 'themes.php?page=saxon_system_information&act=flushcache' ) ?>">Flush theme options cache</a>

				<p>You can reset theme activation if you want to register theme again for some reason.</p>
				<a class="button-primary" href="<?php echo admin_url( 'themes.php?page=saxon_system_information&act=resetactivation' ) ?>">Reset theme activation</a>
				</div>
			</div>
			<?php
		}
